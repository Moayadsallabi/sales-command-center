...
held or not, drawn on the client's own business day (`clients.time_zone` in the
registry, or `CLIENT_TIME_ZONE`; UTC and a note when unset). It sits directly under the
