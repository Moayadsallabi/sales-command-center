...
<!-- Generated by scripts/build-rubric.mjs from rubric/rubric.json. Do not edit by hand. Rubric v1.4.0. -->
...
- Every judgement must be anchored to a specific moment in the transcript. Quote the caller's exact words so they can find the moment.
...
- **The moment** — Identify the single highest-leverage point on the call where a different move would have changed the outcome. Quote the transcript, explain what happened, what should have happened, and why it matters. Two to four sentences.
