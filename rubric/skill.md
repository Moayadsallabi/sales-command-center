...
<!-- Generated by scripts/build-rubric.mjs from rubric/rubric.json. Do not edit by hand. Rubric v2.0.0. -->
...
- **Weakest Belief** — Which of the seven beliefs did the caller build least on this call? The belief the caller left weakest, not the one the prospect arrived weakest on. Answer with one of: Pain, Doubt, Cost, Desire, Money, Support, Trust, None.
